...
echo "[2/4] baseline on the eval split"
python3 eval_model.py --contexts "$CTX" --ids-from "$EVAL_IDS" --model "$BASELINE" --base "$BASE/v1" --out "$OUT/eval_baseline.jsonl" 2>"$OUT/eval_baseline.log"
